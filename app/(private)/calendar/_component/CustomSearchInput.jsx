function CustomSearchInput({
  ...
  return (
    <div className="relative flex-2 flex items-center w-full px-[17px] border shadow-sm  custom-shadow sm:min-w-fit border-color5 text-color03 h-[42px] xl:h-[60px]">
